...
const topCompanies = [
  ...
  { name: 'TCS', color: 'from-blue-700 to-indigo-600' },
  { name: 'Infosys', color: 'from-blue-500 to-purple-500' },
  { name: 'Wipro', color: 'from-orange-600 to-red-500' },
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-8 text-center">
            Top Recruiting <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-purple-500">Companies</span>
          </h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {topCompanies.map((company, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className={`relative bg-gradient-to-br ${company.color} rounded-xl p-6 flex items-center justify-center h-24 shadow-lg hover:shadow-2xl transition-all duration-300`}>
